...
<div class="container cntMargin">   
 <form method="post" class="form-horizontal" action="class7adm.php" enctype="multipart/form-data">
...
if(isset($_POST['submit']))
{
   ...
   $qry="INSERT INTO `myphpdb`.`tbladmclass7` (`id`, `fstname`, `lstname`, `father's_name`, `mother's_name`, `email_ID`, `class`, `dob`, `gender`, `mobile_no`, `addr`, `city`, `country`, `state`, `district`, `pincode`) VALUES ('NULL', '$fstname', '$lstname', '$father_name', '$mother_name', '$email', '$class_name', '$dob', '$gender', '$mobileno', '$addresss', '$city', '$country', '$state', '$district', '$pincode')";
  $run=mysqli_query($qry,$con);
   if($run==true)
   {
       ...
       <?php
	   	   echo "<script>window.location='printadm7cls.php'</script>";
   }
}
?>>