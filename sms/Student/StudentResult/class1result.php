...
<div class="container cntMargin">
  <form method="get" class="form-horizontal" name="contactform" action="print1.php">
    <div class="form-group">
      <div class="col-sm-12" style="font-size:24px; color:blue;">WELCOME TO RESULT DASHBOARD </div>
    </div>
    <div class="form-group">
...
$qry="select * from tblone where id='$search_record'";
...
<table align="center">
  ...
  <h5 align="center">Class-1 School Examination Board 2018 - Annual Result</h5>
  <tr>
  ...
  <tr>
    <th>SUBJECT</th>
    <th>&emsp;&emsp;&emsp;&emsp;&emsp;FULL MARKS</th>
    <th>&emsp;&emsp;PASS MARKS</th>
    <th>&emsp;&emsp;&emsp;OBTAINED MARKS</th>
    <th>Percentage</th>
    <th>Grade</th>
  </tr>
  <tr>
